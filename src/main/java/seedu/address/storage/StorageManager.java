...
public class StorageManager implements Storage {
    ...
    @Override
    public Optional<ReadOnlyGradPad> readAddressBook() throws DataConversionException, IOException {
        return readAddressBook(addressBookStorage.getAddressBookFilePath());
    }

    @Override
    public Optional<ReadOnlyGradPad> readAddressBook(Path filePath) throws DataConversionException, IOException {
