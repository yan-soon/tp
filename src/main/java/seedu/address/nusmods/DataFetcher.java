...
public class DataFetcher {
    public static final String DATA_FILE_PATH = "modules.json";
     ...
     */
    public static void fetchAndSaveModules() throws NusmodsException {
     ...
     * {@code ModuleInfo}.
     */
    public static Optional<ModuleInfo> fetchModuleInfo(String moduleCode) throws NusmodsException {
     ...
     * {@code ModuleSummary}.
     */
    private static List<ModuleSummary> fetchModuleSummaryList() throws NusmodsException {
     ...
     * keyword specified.
     */
    private static List<ModuleSummary> filterModuleSummaries(List<ModuleSummary> modules, String keyword) {
     ...
     */
    private static Map<String, ModuleInfo> generateModuleInfoMap(List<ModuleSummary> moduleSummaries) {
